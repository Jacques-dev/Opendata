...
<html>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              foreach ($results["facet_groups"][0]["facets"] as $diplome) {
                printf("<div><input onclick='selectionView(\"%s\")' type='checkbox' name='checkboxdiplome[]' value=\"%s\"><label for=\"%s\">%s</label></div>",$diplome["name"],$diplome["name"],$diplome["name"],$diplome["name"]);
              }
              ?>
            </div>
          </div>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              foreach ($results2["facet_groups"][0]["facets"] as $formation) {
                printf("<div><input onclick='selectionView(\"%s\")' type='checkbox' name='checkboxformation[]' value=\"%s\"><label for=\"%s\">%s</label></div>",$formation["name"],$formation["name"],$formation["name"],$formation["name"]);
              }
              ?>
            </div>
          </div>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              foreach ($results3["facet_groups"][0]["facets"] as $region) {
                printf("<div><input onclick='selectionView(\"%s\")' type='checkbox' name='checkboxregion[]' value=\"%s\"><label for=\"%s\">%s</label></div>",$region["name"],$region["name"],$region["name"],$region["name"]);
              }
              ?>
            </div>
          </div>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              foreach ($results4["facet_groups"][0]["facets"] as $departement) {
                printf("<div><input onclick='selectionView(\"%s\")' type='checkbox' name='checkboxdepartement[]' value=\"%s\"><label for=\"%s\">%s</label></div>",$departement["name"],$departement["name"],$departement["name"],$departement["name"]);
              }
              ?>
            </div>
          </div>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              foreach ($results5["facet_groups"][0]["facets"] as $ville) {
                printf("<div><input onclick='selectionView(\"%s\")' type='checkbox' name='checkboxville[]' value=\"%s\"><label for=\"%s\">%s</label></div>",$ville["name"],$ville["name"],$ville["name"],$ville["name"]);
              }
              ?>
            </div>
          </div>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              foreach ($results6["facet_groups"][1]["facets"] as $academie) {
                printf("<div><input onclick='selectionView(\"%s\")' type='checkbox' name='checkboxacademie[]' value=\"%s\"><label for=\"%s\">%s</label></div>",$academie["name"],$academie["name"],$academie["name"],$academie["name"]);
              }
              ?>
            </div>
          </div>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              foreach ($results7["facet_groups"][0]["facets"] as $etablissement) {
                printf("<div><input id='etablissementID' onclick='selectionView(\"%s\")' type='checkbox' name='checkboxetablissement[]' value=\"%s\"><label for=\"%s\">%s</label></div>",$etablissement["name"],$etablissement["name"],$etablissement["name"],$etablissement["name"]);
              }
              ?>
            </div>
          </div>
  ...
  <script>/*
    function submitdata() {
      ...
      var checkboxdiplome = document.getElementById('diplomeID');
      var checkboxformation = document.getElementById('formationID');
      var checkboxregion = document.getElementById('regionID');
      var checkboxdepartement = document.getElementById('departementID');
      var checkboxville = document.getElementById('villeID');
      var checkboxacademie = document.getElementById('academieID');
      var checkboxetablissement = document.getElementById('etablissementID');
      
      $.ajax({
        type: 'post',
        url: 'index.php',
        data: {
          diplomeID:checkboxdiplome,
          formationID:checkboxformation,
          regionID:checkboxregion,
          departementID:checkboxdepartement,
          villeID:checkboxville,
          academieID:checkboxacademie,
          etablissementID:checkboxetablissement;
        },
        success: function (response) {
          $('#leftcolumn').html("You data will be saved");
        }
      });
      return false;
    }*/
